...
export default function CarouselTab() {
 ...
 {/* ---------------- ฟอร์มเพิ่มแบนเนอร์ ---------------- */}
 <form onSubmit={handleCreate} className="bg-canvas p-8 lg:p-10 rounded-md shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-hairline relative overflow-hidden w-full">
 ...
 {items.map(item => (
 <div key={String(item.id)} className="bg-canvas rounded-md border border-hairline shadow-sm hover:shadow-md transition-all overflow-hidden flex flex-col group">
 <div className="aspect-video w-full bg-surface-soft relative overflow-hidden">
 ...
 {!item.is_active && (
 <div className="absolute inset-0 bg-canvas/50 backdrop-blur-sm flex items-center justify-center">
 <span className="bg-red-500 text-white px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest">Hidden</span>
 </div>
 )}
 <div className="absolute top-3 left-3 bg-canvas/60 text-white px-3 py-1 rounded-sm text-xs font-bold">
 ...
 <div className="p-4 bg-canvas/80 /80 border-t border-hairline grid grid-cols-2 gap-2 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity">
 ...
 <div className="px-8 py-5 border-b border-hairline flex justify-between items-center">
 ...
 <button type="button" onClick={() => setEditingItem(null)} className="px-6 py-3 bg-canvas border border-hairline text-ink rounded-md font-bold hover:bg-surface-soft dark:hover:bg-gray-600 transition-colors">
 ยกเลิก
 </button>
