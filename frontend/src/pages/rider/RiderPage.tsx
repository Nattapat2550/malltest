  ...
  return (
    <div className="w-full min-h-screen bg-canvas  transition-colors duration-300">
      <div className="bg-white  border-b border-gray-200  pt-8 pb-4 px-6 lg:px-12">
        <h1 className="text-3xl font-black text-gray-900  mb-2">Rider Dashboard</h1>
        <p className="text-gray-500 ">รหัสพนักงานของคุณ: <span className="font-bold text-pink-600">#{riderId || '-'}</span></p>
      ...
      <div className="p-6 lg:p-12 max-w-5xl mx-auto">
        ...
        {activeTab === 'current' && (
          <div className="grid gap-6">
            {currentJobs.length === 0 ? (
              ...
              <div key={idx} className="bg-white  rounded-md p-6 shadow-sm border border-gray-200  flex flex-col md:flex-row justify-between gap-6">
                <div>
                  ...
                  <div className="p-4 bg-canvas  rounded-md text-sm  border ">
                    <div className="font-bold text-gray-700  mb-1">📍 ที่อยู่จัดส่ง:</div>
        ...
        {activeTab === 'history' && (
          <div className="bg-white  rounded-md p-6 shadow-sm overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-canvas  text-gray-500 text-sm border-b ">
      ...
      {showUpdateModal && selectedShipment && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-canvas/50 p-4 backdrop-blur-sm">
          <div className="bg-white  rounded-md w-full max-w-sm p-6 shadow-2xl">
            ...
            <form onSubmit={submitUpdate} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 mt-6 pt-4 border-t ">
                <button type="button" onClick={() => setShowUpdateModal(false)} className="px-4 py-2 bg-surface-soft hover:bg-gray-200  dark:hover:bg-gray-600  rounded-md font-bold transition">ยกเลิก</button>
