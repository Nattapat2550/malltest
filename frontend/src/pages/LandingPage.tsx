...
const LandingPage = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 dark:bg-slate-900 pb-20 transition-colors duration-300 overflow-x-hidden">
      ...
      <div className="relative pt-20 pb-16 md:pt-24 md:pb-20 flex flex-col items-center justify-center text-center px-6">
        ...
        <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 max-w-2xl mb-10 font-medium">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md justify-center">
          ...
          <Link 
            to="/login" 
            className="flex-1 bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-500 text-slate-900 dark:text-white font-bold py-3 px-6 rounded-xl shadow-sm transition-all text-center flex items-center justify-center"
          >
            เข้าสู่ระบบ
          </Link>
        </div>
