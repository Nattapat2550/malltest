...
export default function CheckoutPage() {
 ...
 <div className="bg-canvas rounded-md p-6 lg:p-8 shadow-sm border border-slate-200 ">
 ...
 <div className="absolute z-10 w-full mt-1 bg-canvas border border-slate-200 rounded-md shadow-lg max-h-48 overflow-y-auto">
 ...
 * ขาดอีก ฿{(total - walletBalance).toLocaleString(undefined, { minimumFractionDigits: 2 })}
 ...
 <div className="bg-canvas rounded-md p-6 shadow-sm border border-slate-200 ">
 ...
 className={promoCode === p.code ? "px-3 py-1.5 text-xs font-bold rounded-md border transition-all bg-primary text-white border-blue-600 shadow-md" : "px-3 py-1.5 text-xs font-bold rounded-md border transition-all bg-canvas text-primary border-blue-200 hover:bg-canvas"}
 >
 {p.code}
 </button>
 ))}
