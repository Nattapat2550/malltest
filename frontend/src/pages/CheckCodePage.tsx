      ...
      <form onSubmit={handleSubmit} className="space-y-4 text-left">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 text-center tracking-widest text-lg bg-canvas  border border-gray-300  rounded-sm focus:ring-2 focus:ring-blue-500 outline-none transition text-gray-900 "
          />
        </div>
