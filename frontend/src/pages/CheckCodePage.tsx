...
const CheckCodePage = () => {
 ...
 return (
 <div className="max-w-md w-full mx-auto mt-10 p-8 bg-canvas rounded-md shadow-lg border border-hairline text-center">
 ...
 className="w-full px-4 py-2 text-center tracking-widest text-lg bg-canvas border border-hairline rounded-sm focus:ring-2 focus:ring-blue-500 outline-none transition text-ink "
 />
 </div>
