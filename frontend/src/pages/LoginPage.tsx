...
export default function LoginPage() {
  ...
  return (
    <div className="flex justify-center items-center min-h-[80vh]">
      <div className="w-full max-w-md bg-white  p-8 rounded-sm shadow-xl border ">
        ...
        <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center bg-white  border border-gray-300  text-gray-700  font-bold py-2 px-4 rounded-sm hover:bg-canvas dark:hover:bg-gray-600 transition">
