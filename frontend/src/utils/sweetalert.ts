...
export const AppleSwal = MySwal.mixin({
  customClass: {
    ...
    confirmButton: 'bg-black text-white rounded-full px-8 py-3 font-semibold hover:bg-canvas transition-all focus:ring-4 focus:ring-gray-200 outline-none w-full sm:w-auto mt-4',
