...
export const AppleSwal = MySwal.mixin({
 ...
 cancelButton: 'bg-surface-soft text-ink rounded-full px-8 py-3 font-semibold hover:bg-surface-soft transition-all ml-0 sm:ml-3 mt-3 sm:mt-4 focus:ring-4 focus:ring-gray-200 outline-none w-full sm:w-auto',
