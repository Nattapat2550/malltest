...
export const AppleSwal = MySwal.mixin({
  customClass: {
    ...
    confirmButton: 'bg-zinc-950 text-white rounded-full px-8 py-3 font-semibold hover:bg-canvas transition-all focus:ring-4 focus:ring-gray-200 outline-none w-full sm:w-auto mt-4',
    cancelButton: 'bg-surface-soft text-gray-700 rounded-full px-8 py-3 font-semibold hover:bg-gray-200 transition-all ml-0 sm:ml-3 mt-3 sm:mt-4 focus:ring-4 focus:ring-gray-200 outline-none w-full sm:w-auto',
