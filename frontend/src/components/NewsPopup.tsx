...
export default function NewsPopup() {
 ...
 <div className="bg-canvas p-6 rounded-sm max-w-2xl w-full relative max-h-[90vh] flex flex-col">
 <button 
 ...
 className="w-4 h-4 text-primary rounded border-hairline focus:ring-blue-500"
 />
 <span className="text-ink text-sm font-medium">รับทราบและไม่แสดงหน้านี้อีกจนกว่าจะมีข่าวใหม่</span>
 </label>
